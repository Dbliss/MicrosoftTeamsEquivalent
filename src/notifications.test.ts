...
describe("Testing Notifications", () => {
  ...
  test("Valid, Has 25 notifications, Show 20", () => {
    ...
    let expectedNotification = {notifications: []};
    ...
    for(let i = 0; i < 19; i++) {
      expectedNotification.notifications.push({
        channelId: -1, 
        dmId: dmCreated.dmId, 
        notificationMessage: "firstlast tagged you in 'first1last1, firstlast': @first2last2 Hi",
      });
    }
  ...
  describe("DM notifications", () => {
    ...
    test("Valid, Tagged in dm message(More than 20 characters), Is member", () => {
      ...
      },
      {
        channelId: -1, 
        dmId: dmCreated.dmId, 
        notificationMessage: "firstlast tagged you in 'first1last1, firstlast': @first2last2 Whats u",
      }
      ]});
    });
